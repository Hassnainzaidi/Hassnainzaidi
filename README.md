...
- 🌊 **Ocean Waste Analysis** — ML models for environmental impact  
- 🧑‍🤝‍🧑 **Human Faces Dataset** — Curated dataset for CV tasks  
- 🎨 **AI Art vs Human Art** — Comparative dataset for creativity analysis  
- 💰 **Gold Pulse USD** — Time‑series forecasting of gold prices  
- 📄 **Resume Classification (NLP)** — Text classification for recruitment automation  
